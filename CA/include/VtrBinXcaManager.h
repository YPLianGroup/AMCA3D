#ifndef VTRBinXcaManager_H
#define VTRBinXcaManager_H
...
class ExtendedCellularAutomataManager;

class VtrBinXcaManager : public VtkManager
{
public:
  // Constructor
  VtrBinXcaManager(ExtendedCellularAutomataManager *XcaManager);

  // Destructor
  virtual ~VtrBinXcaManager();

  ExtendedCellularAutomataManager * XcaManager_;
