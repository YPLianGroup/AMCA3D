#ifndef VTRBinMANAGER_H
#define VTRBinMANAGER_H
...
class VtrBinManager : public VtkManager
{
public:
  // Constructor
  VtrBinManager(CellularAutomataManager_3D *caManager);

  // Destructor
  virtual ~VtrBinManager();
